...
var { SectionsExaminationsGroupMonth } = require('../../../models/Courses/Examinations/GroupMonth')
 ...
 router.get('/examination-group-month-create-sections', (req, res) => {
...
router.get('/examination-group-month-deletefields', (req, res) => {
...
router.get('/examination-group-month', (req, res) => {
