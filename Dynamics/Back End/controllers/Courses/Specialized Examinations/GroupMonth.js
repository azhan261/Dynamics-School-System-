...
var { SectionsSpecialExaminationsGroupMonth} = require('../../../models/Courses/Specialized Examinations/GroupMonth')
 ...
 router.get('/specialExamination-group-month-create-sections', (req, res) => {
...
router.get('/specialExamination-group-month-deletefields', (req, res) => {
...
router.get('/specialExamination-group-month', (req, res) => {
