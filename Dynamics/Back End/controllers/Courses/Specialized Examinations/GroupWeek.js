...
var { SectionsSpecialExaminationsGroupWeek} = require('../../../models/Courses/Specialized Examinations/GroupWeek')
 ...
 router.get('/specialExamination-group-week-create-sections', (req, res) => {
...
router.get('/specialExamination-group-week-deletefields', (req, res) => {
...
router.get('/specialExamination-group-week', (req, res) => {
