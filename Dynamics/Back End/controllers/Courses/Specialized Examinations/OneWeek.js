...
var { SectionsSpecialExaminationsOneWeek} = require('../../../models/Courses/Specialized Examinations/OneWeek')
 ...
 router.get('/specialExamination-one-week-create-sections', (req, res) => {
...
router.get('/specialExamination-one-week-deletefields', (req, res) => {
...
router.get('/specialExamination-one-week', (req, res) => {
