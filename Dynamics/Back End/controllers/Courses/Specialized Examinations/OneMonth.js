...
var { SectionsSpecialExaminationsOneMonth} = require('../../../models/Courses/Specialized Examinations/OneMonth')
 ...
 router.get('/specialExamination-one-month-create-sections', (req, res) => {
...
router.get('/specialExamination-one-month-deletefields', (req, res) => {
...
router.get('/specialExamination-one-month', (req, res) => {
